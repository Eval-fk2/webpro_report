\chapter{Overwatchキャラ一覧 開発者向け仕様書}

\section{サービス概要}
Overwatchキャラ一覧とは，FPSゲーム，Overwatch2に登場する多くのキャラの情報をまとめたサービスである．
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm\textwidth]{fig/folder_overwatch.png}
  \caption{フォルダ構成}
  \label{fig:folder_overwatch}
\end{figure}
...
\begin{lstlisting}[language=javascript]
    ...
    function setDefaultData() {
      const defaultData = [
        ['キャラ名', 'ロール', 'HP', 'メイン攻撃', 'サブ攻撃', 'アビリティ1', 'アビリティ2', 'アルティメット', 'パッシブ'],
        ['キャラ名', 'ロール', 'HP', 'メイン攻撃', 'サブ攻撃', 'アビリティ1', 'アビリティ2', 'アルティメット', 'パッシブ'],
        ['キャラ名', 'ロール', 'HP', 'メイン攻撃', 'サブ攻撃', 'アビリティ1', 'アビリティ2', 'アルティメット', 'パッシブ'],
        ...
...
\begin{itemize}
    ...
    \item '/db\_add\_complete'(47行目): キャラの追加処理を行う機能を持つ．\\
    ...
    \item '/db\_remove\_complete/:id'(63行目): キャラの削除処理を行う機能を持つ．\\
    ...
    \item '/db\_edit\_complete/:id'(79行目): キャラの編集処理を行う機能を持つ．\\
...
db.ejsは複数のキャラ情報の一覧を表示するためのページであり，
各キャラのidや設定された項目値を表形式で表示する機能を持つ．
また，追加ページや詳細ページへの遷移リンクも提供する．

\begin{figure}[H]
  \centering
  \includegraphics[width=15cm\textwidth]{fig/ow_list_page.png}
  \caption{一覧表示ページ}
  \label{fig:ow_list_page_dev}
\end{figure}
...
\begin{lstlisting}[language=ejs]
    ...
    <head>
      <meta charset="utf-8">
      <title>Orangestarキャラ一覧</title>
    </head>
    <body>
      <h2>Orangestarキャラ一覧</h2>
...
\begin{figure}[H]
  \centering
  \includegraphics[width=11cm\textwidth]{fig/ow_detail_page.png}
  \caption{詳細表示ページ}
  \label{fig:ow_detail_page_dev}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm\textwidth]{fig/ow_add_page.png}
  \caption{追加ページ}
  \label{fig:ow_add_page_dev}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm\textwidth]{fig/ow_edit_page.png}
  \caption{編集ページ}
  \label{fig:ow_edit_page_dev}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=11cm\textwidth]{fig/ow_remove_page.png}
  \caption{削除ページ}
  \label{fig:ow_remove_page_dev}
\end{figure}
